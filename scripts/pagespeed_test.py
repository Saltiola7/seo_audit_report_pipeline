...
env_path = '/Users/tis/github/seo_audit_reports/.env'
load_dotenv(env_path)

# Define the output directory for JSON files
OUTPUT_DIR = Path('/Users/tis/github/seo_audit_reports/scripts/temp')
...
def append_to_duckdb(data, url):
    conn = duckdb.connect('/Users/tis/github/seo_audit_reports/sources/seo/crawl.duckdb')
...
if __name__ == "__main__":
    con = duckdb.connect('/Users/tis/github/seo_audit_reports/sources/seo/crawl.duckdb')
